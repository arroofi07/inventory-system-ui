	...
	export const buttonVariants = tv({
		...
		variants: {
			variant: {
				...
				outline: "border-primary/30 bg-background dark:bg-transparent hover:bg-primary/10 hover:text-primary dark:hover:bg-primary/15 aria-expanded:bg-primary/10 aria-expanded:text-primary",
				secondary: "bg-secondary text-secondary-foreground hover:bg-primary/15 aria-expanded:bg-secondary aria-expanded:text-secondary-foreground",
				ghost: "hover:bg-primary/10 hover:text-primary dark:hover:bg-primary/15 aria-expanded:bg-primary/10 aria-expanded:text-primary",
